                ...
                <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="h-4 bg-gradient-to-r from-primary-200 to-accent-200 rounded w-3/4"></div>
                      <div className="h-3 bg-gray-200 rounded w-full"></div>
                      <div className="h-3 bg-gray-200 rounded w-5/6"></div>
                      <div className="mt-6 grid grid-cols-2 gap-3">
                        <div className="h-16 bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg"></div>
                        <div className="h-16 bg-gradient-to-br from-accent-100 to-accent-200 rounded-lg"></div>
                      </div>
                      <div className="mt-4 h-8 gradient-accent rounded-lg"></div>
                    </div>
                  </div>
                </div>
              </div>
